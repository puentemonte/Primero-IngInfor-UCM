...
// calcula la puntuacion de una mina con la fórmula que se da
int puntos(const tJuego &juego);

// MENÚS PRINCIPALES
// menú en el que se pide al jugador elegir la mina que quiere jugar
int menuPartida(string& nombre);
// menú en el que se le pide al usuario su nombre
